...
class RecordExPreviewScreen extends StatefulWidget {
  final String file;
  final String exerciseId;

  const RecordExPreviewScreen(
      {super.key, required this.file, required this.exerciseId});

  @override
  State<RecordExPreviewScreen> createState() => _RecordExPreviewScreenState();
}

class _RecordExPreviewScreenState extends State<RecordExPreviewScreen> {
