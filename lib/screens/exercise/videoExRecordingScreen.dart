...
import 'recordExPreviewScreen.dart';

class VideoExRecording extends StatefulWidget {
  final String exerciseId;

  const VideoExRecording({super.key, required this.exerciseId});

  @override
  State<VideoExRecording> createState() => _VideoExRecordingState();
}

class _VideoExRecordingState extends State<VideoExRecording>
              ...
              onTap: () async {
                if (isRecording == true) {
                  await _cameraController!.stopVideoRecording().then((value) {
                    ...
                    navPush(
                        context: context,
                        action: RecordExPreviewScreen(
                            file: value.path, exerciseId: widget.exerciseId));
      ...
      setState(() {
        if (pickedFile != null) {
          ...
          navPush(
              context: context,
              action: RecordExPreviewScreen(
                  file: galleryFile!.path, exerciseId: widget.exerciseId));
