...
class _ExercisesScreenState extends State<ExercisesScreen> {
    ...
    showDialog(
        ...
        builder: (context) {
          return StatefulBuilder(builder: (context, setState) {
            // Use StatefulBuilder to update local state
            List<String> challengedUserIds = []; // Track challenged user IDs
                      ...
                      children: [
                        ...
                        ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            bool isAlreadyChallenged =
                                challengedUserIds.contains(item
                                    .userId); // Check if the user is already challenged
                            return Container(
                              child: Row(
                                children: [
                                  cacheImages(
  ...
  Future<void> onChallenge({
    ...
    required List<String> challengedUserIds,
  }) async {
    ...
    pro.challengeUser(context: context, data: data).then((value) {
      if (pro.isChallenged) {
        challengedUserIds
            .add(challengeId); // Add the challenged user ID to the list
      ...
      log('ChallengeData -------- ${pro.msg}    ${pro.isChallenged}');
    });
  }
                                  ...
                                  InkWell(
                                    onTap: isChallenged
                                        ...
                                        : () {
                                            ...
                                            setState(() {
                                              isChallenged =
                                                  true; // Update local state to indicate challenge sent
                                            });
                                          },
                                    child: Container(
                                      margin: EdgeInsets.only(right: 10),
