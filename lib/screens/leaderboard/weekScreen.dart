...
class _WeekScreenState extends State<WeekScreen> {
  ...
  _initFun() async {
    ...
    pro.getLeaderboardWeek(context: context, data: data, isHome: false);
  }
  ...
  Widget get tabviewWeek => SingleChildScrollView(
        ...
        child: Consumer<LeaderboardProvider>(builder: (context, data, child) {
          return Column(
            children: [
              ...
              levelSection,
              topLeaders(data.leaderWeekTop),
              if (data.leaderWeekTop.isNotEmpty)
                AppImage("assets/linedivider.svg"),
              if (data.leaderWeekTop.isNotEmpty) locationSection,
              if (data.leaderWeekTop.isNotEmpty)
                AppImage("assets/linedivider.svg"),
              SizedBox(
                height: 20,
              ),
              listLeaders(data.leaderboardWeekList),
            ],
          );
        }),
      );
