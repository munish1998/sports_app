...
class RecordPrPreviewScreen extends StatefulWidget {
  final String file;
  final String practiceId;

  const RecordPrPreviewScreen(
      {super.key, required this.file, required this.practiceId});

  @override
  State<RecordPrPreviewScreen> createState() => _RecordPrPreviewScreenState();
}

class _RecordPrPreviewScreenState extends State<RecordPrPreviewScreen> {
