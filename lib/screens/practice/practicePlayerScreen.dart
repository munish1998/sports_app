...
import 'videoPrRecordingScreen.dart';

class PracticePlayerScreen extends StatefulWidget {
  final List<PracticeModel> practice;

  const PracticePlayerScreen({super.key, required this.practice});
            ...
            children: [
              ...
              Swiper(
                itemBuilder: (BuildContext context, int index) {
                  return PracticeContentScreen(
                    practice: widget.practice[index],
                  );
                },
                itemCount: widget.practice.length,
...
class PracticeContentScreen extends StatefulWidget {
  final PracticeModel practice;

  const PracticeContentScreen({Key? key, required this.practice})
      : super(key: key);

  @override
  State<PracticeContentScreen> createState() => _PracticeContentScreenState();
}

class _PracticeContentScreenState extends State<PracticeContentScreen> {
  ...
  Future initializePlayer() async {
    ...
    _videoPlayerController =
        VideoPlayerController.networkUrl(Uri.parse(widget.practice.video));
  ...
  Widget get practiceBTN => InkWell(
        onTap: () {
          ...
          //   'practice_id': widget.practice.id,
          // };
          // pro.completeExercises(context: context, data: data);
          navPush(
              context: context,
              action: VideoPrRecording(practiceId: widget.practice.id));
        },
        child: Padding(
