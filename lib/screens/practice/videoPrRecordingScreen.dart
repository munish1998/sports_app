...
import 'recordPrPreviewScreen.dart';

class VideoPrRecording extends StatefulWidget {
  final String practiceId;

  const VideoPrRecording({super.key, required this.practiceId});

  @override
  State<VideoPrRecording> createState() => _VideoPrRecordingState();
}

class _VideoPrRecordingState extends State<VideoPrRecording>
              ...
              onTap: () async {
                if (isRecording == true) {
                  await _cameraController!.stopVideoRecording().then((value) {
                    ...
                    navPush(
                        context: context,
                        action: RecordPrPreviewScreen(
                            file: value.path, practiceId: widget.practiceId));
      ...
      setState(() {
        if (pickedFile != null) {
          ...
          navPush(
              context: context,
              action: RecordPrPreviewScreen(
                  file: galleryFile!.path, practiceId: widget.practiceId));
